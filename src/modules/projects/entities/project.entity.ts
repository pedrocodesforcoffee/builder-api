...
import { Budget } from '../../financials/entities/budget.entity';
import { PrimeContract } from '../../financials/entities/prime-contract.entity';
...
export class Project {
   ...
   * Null means the project is not archived
   */
  @Column({
    type: 'timestamp',
    nullable: true,
  ...
  /**
   * Cost codes
   * Relationship to cost codes for this project
   */
  @OneToMany(() => CostCode, (costCode) => costCode.project)
  costCodes?: CostCode[];

  /**
   * Budgets
   * Relationship to budgets for this project
   */
  ...
  /**
   * Prime contracts
   * Relationship to prime contracts for this project
   */
  @OneToMany(() => PrimeContract, (contract) => contract.project)
  primeContracts?: PrimeContract[];

  /**
   * Commitments (subcontracts and purchase orders)
   * Relationship to commitments for this project
   */
